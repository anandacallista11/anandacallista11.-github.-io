...
<body>
    <div class="container p-4">
        ...
        <form method="post" action="../controller/tambah_siswa.php">
            ...
            <input type="text" name="jmsaudara" required>
            <br><br>
            <label for="">Kelas :</label>
            <select name="idkelas" id="" required>
                <option value="1">XI RPL 1</option>
                <option value="2">XI KPR 3</option>
                <option value="3">XI ANM 1</option>
            </select>
            <br><br>
    ...
    <div class="container p-4">
        <table border="1" width="83%" align="center" class="table">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Nama</th>
            ...
            <tbody>
                ...
                while ($siswa = mysqli_fecth_array($query)) {
                }
                ?> 
                    <tr>
                        <td><?= $no++ ?></td>
    ...
    <div class="container p-4">
        <form action="../controller/logout.php" method="post">
            <div class="input-group">
                <button class="btn bg-denger text-white">Logout</button>
            </div>
        </form>
    </div>
</body>
